...
const TextInputProperties = ({element, onChange}) => {
  ...
  return (
    ...
    {/* label */}
        ...
        <input type="text" value={props.label} onChange={(e)=>{onChange('label',e.target.value)}} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
